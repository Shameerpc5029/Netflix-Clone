...
mixin _$FastLaughState {
  List<Downloads> get likedVideosList => throw _privateConstructorUsedError;
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<Downloads> likedVideosList,
...
class _$FastLaughStateCopyWithImpl<$Res, $Val extends FastLaughState>
  ...
  @override
  $Res call({
    Object? likedVideosList = null,
    Object? videosList = null,
    Object? isLoding = null,
    Object? isError = null,
  }) {
    return _then(_value.copyWith(
      likedVideosList: null == likedVideosList
          ? _value.likedVideosList
          : likedVideosList // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      {final List<Downloads> likedVideosList = const [],
      required final List<Downloads> videosList,
      required this.isLoding,
      required this.isError})
      : _likedVideosList = likedVideosList,
        _videosList = videosList;

  final List<Downloads> _likedVideosList;
  @override
  @JsonKey()
  List<Downloads> get likedVideosList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_likedVideosList);
  }
  ...
  @override
  String toString() {
    return 'FastLaughState(likedVideosList: $likedVideosList, videosList: $videosList, isLoding: $isLoding, isError: $isError)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._likedVideosList, _likedVideosList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_likedVideosList),
...
abstract class _Initial implements FastLaughState {
  const factory _Initial(
      {final List<Downloads> likedVideosList,
      required final List<Downloads> videosList,
